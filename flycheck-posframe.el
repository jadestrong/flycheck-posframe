...
(defun flycheck-posframe-hide-frame ()
  "Hide messages currently being shown if any."
  (message "flycheck-posframe-hide-frame")
  (when (frame-live-p flycheck-posframe-buffer)
    (posframe-hide flycheck-posframe-buffer))
  (remove-hook 'pre-command-hook 'flycheck-posframe-hide-frame t))
...
(defun flycheck-posframe-show-posframe (errors)
  ...
  (when (and errors
    ...
    (let ((poshandler (intern (format "posframe-poshandler-%s" flycheck-posframe-position))))
      ...
      (add-hook 'pre-command-hook 'flycheck-posframe-hide-frame nil t))))
    ...
    (cond
     ...
     ((and flycheck-posframe-mode
      ...
      (setq-local flycheck-display-errors-function
                  #'flycheck-posframe-show-posframe)
      (dolist (hook hooks)
        (add-hook hook #'flycheck-posframe-hide-frame nil t)))
     ...
     ((and (not flycheck-posframe-mode)
      ...
      (dolist (hook hooks)
        (remove-hook hook 'flycheck-posframe-hide-frame t))))))
